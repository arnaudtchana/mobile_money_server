<?php
/**
 * Created by Foris Fomekong.
 * this file is a part of rest-api-helper available on the repository of foris-master
 * User: Foris
 * Date: 20/10/2016
 * Time: 23:13
 */
...
//        dd($wantFields);
        ...
        foreach ($data as $key => $value) {
            $tkey = explode('-',$key);
            $op="=";
            if (count($tkey) == 2 && (in_array($tkey[0], $field) || in_array($tkey[0], $dates))) {
